...
const Hero = () => {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div className="max-w-screen-md mb-8 lg:mb-16">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">We are here for investers like you..</h2>
          <p className="text-gray-500 sm:text-xl dark:text-gray-400">We pioneered the discount broking model in Bangladesh.
      ...
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Since 2015</h3>
              <p className="text-gray-500 dark:text-gray-400">We kick-started operations on the 18th of July, 2015 with the goal of breaking all barriers that traders and investors face in Bangladesh in terms of cost, support, and technology.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Achievements</h3>
              <p className="text-gray-500 dark:text-gray-400">Over 1+ Crore clients place millions of orders every day through our powerful ecosystem of investment platforms, contributing over 15% of all Bangladeshi retail trading volumes.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Education</h3>
              <p className="text-gray-500 dark:text-gray-400"> we run a number of popular open online educational and community initiatives to empower retail traders and investors.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Best Pricing</h3>
              <p className="text-gray-500 dark:text-gray-400">Today, our disruptive pricing models and in-house technology have made us the biggest stock broker in Bangladesh.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Stay tuned</h3>
              <p className="text-gray-500 dark:text-gray-400">We are always up to something new every day. Catch up on the latest updates on our blog or see what the media is saying about us.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p className="text-gray-500 dark:text-gray-400">Trade legally anywhere in the globe using the ecosystem of StockEx.</p>
          </div>
      </div>
  </div>
</section>
